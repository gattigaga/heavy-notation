...
const HomeTemplate = ({ lang = "en" }: Props) => {
  ...
  return (
    <>
      ...
      <main className="flex max-w-screen-2xl flex-col gap-y-24 px-8 pt-4 md:gap-y-40 md:pt-10 lg:pt-16 2xl:mx-auto">
        <section className="flex flex-col md:px-16 lg:px-24 2xl:px-40">
          <TypingAnimation
        ...
        <section className="md:px-16 lg:px-24 2xl:px-40">
        ...
        <section className="flex flex-col items-center rounded-lg bg-zinc-100 p-8 md:p-16 lg:p-24 dark:bg-zinc-800">
